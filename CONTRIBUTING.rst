...
Thank you for your help improving **pyGal GEE**!

**pyGal GEE** uses `nox <https://nox.thea.codes/en/stable/>`__ to automate several development-related tasks.
...
First off, you'll need your own copy of **pyGal GEE** codebase. You can clone it for local development like so:
...
.. code-block:: console
   ...
   git clone https://github.com/<YOUR USERNAME>/pygalgee
   cd pygalgee
...
This will install the **pyGal GEE** library, together with two additional tools:
